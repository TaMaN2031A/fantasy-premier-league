    ...
    <div className="py-4 bg-gradient-to-r from-slate-800 to-gray-900 min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-between">
        ...
        <div className="mt-20">
          <ul className="">
            {isLoading ? (
              <div role="status" class="max-w-5xl animate-pulse">
                <ul class="mt-5 space-y-3">
                  <li class="w-3/5 h-4 bg-gray-200 rounded-full dark:bg-gray-700"></li>
                  <li class="w-4/5 h-4 bg-gray-200 rounded-full dark:bg-gray-700"></li>
                  <li class="w-3/5 h-4 bg-gray-200 rounded-full dark:bg-gray-700"></li>
                  <li class="w-4/5 h-4 bg-gray-200 rounded-full dark:bg-gray-700"></li>
              ...
              data.map((item, index) => (
                <li
                  className="text-left mb-16 transform hover:scale-y-105 transition duration-700"
                  key={item.faqID}
                >
                  {/* Question */}
                  ...
                  <div className="flex flex-row items-start">
                    <div className="bg-indigo-100 p-5 px-10 w-full flex rounded-xl items-center">
                      <p className="text-gray-700 text-2xl"> {item.answer} </p>
                    </div>
